        ...
        <div class="g_content">
            ...
            <form name="frmBuy" id="frmBuy" method="post" enctype="multipart/form-data" action="index_ok.php">
                ...
                <table class="g_green_table private_area">
                    ...
                    070-3595-6151                </span> (
                            <label>
                                <input type="checkbox" class="g_checkbox" name="user_cell_check" id="chk_user_cell_check" value="on" checked> 자택번호안내</label> ) / <span id="spnUserCell">010-2424-0956</span> <a href="javascript:_window.open('private_edit', '/user/contact_edit.html', 496, 350);" class="btn_white1 after">연락처 수정</a> </td>
                    </tr>
