...
@section('content')
    ...
    <div class="g_container" id="g_CONTENT">
        ...
        <div class="g_content">
            ...
            <!-- ▼ 메뉴탭 //-->
            <div class="g_tab">
                <div class='selected'><a href="/myroom/buy/buy_regist.html?strRelationType=regist">구매등록물품</a></div>
                ...
                <div class=""><a href="/myroom/buy/buy_ing.html?strRelationType=ing">구매중인 물품</a></div>
            ...
            <ul class="tab_sib">
                ...
                <li class="g_right"> <a href="/buy/?type=general" class="regist_btn01 btn_green2">구매 등록 ></a> </li>
            </ul>
            <!-- ▲ 테이블 상단 //-->
            ...
            <form id="frmList" method="post">
                ...
                </table> <a href="javascript:;" onclick="tradeProcess('deleteSelectAll');" class="regist_btn11 btn_padding03">현재 페이지 물품 삭제</a> </form>
            <!-- ▲ 구매등록물품 //-->
