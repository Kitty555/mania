(function(a) {
    ...
    var d = function(l, p) {
        ...
        k.list.innerHTML = '<li class="search_ing">ê²€ìƒ‰ì¤‘ìž…ë‹ˆë‹¤....</li>';
    ...
    d.prototype = {
        ...
        onKeyup: function(k, n) {
            ...
            if(this.value.isEmpty() === true) {
                ...
                k.list.innerHTML = '<li class="search_ing">ê²€ìƒ‰ ê²°ê³¼ê°€ ì—†ìŠµë‹ˆë‹¤.</li>';
                k.searchText = "";
                if(k.gameserver.serverList) {
...
$.extend(_suggest, {
    ...
    initialize: function(c) {
        ...
        if(e && e.attr("name") === "selected" && !e.val().isEmpty() && ("applyDefault" in this)) {
            ...
            if(this.type === "gamelist") {
                this.nodeSearch.val("ê²Œìž„ê²€ìƒ‰")
            } else {
                if(this.type === "serverlist") {
                    this.nodeSearch.val("ì„œë²„ê²€ìƒ‰")
                }
            }
        }
        if(this.type === "serverlist") {
...
$.extend(_gamelist, {
    ...
    OnOpen: function(b) {
        var a = this;
        if(this.nodeSearch.val() === "ê²Œìž„ê²€ìƒ‰" || this.nodeSearch.val() === "ì„œë²„ê²€ìƒ‰") {
            this.nodeSearch.val("")
        }
        ...
        var c = this.addOption(null, null, "ê²€ìƒ‰ì¤‘ìž…ë‹ˆë‹¤...");
        c.click = _DISABLE;
    ...
    OnFocus: function() {
        if(this.nodeSearch.val() === "ê²Œìž„ê²€ìƒ‰") {
            this.nodeSearch.val("")
        }
    ...
    fnPrint: function() {
        ...
        if(this.nodeList.children().length < 1) {
            var a = this.addOption(null, null, "ê²€ìƒ‰ê²°ê³¼ê°€ ì—†ìŠµë‹ˆë‹¤.");
            a.click = _DISABLE;
...
$.extend(_serverlist, {
    ...
    OnOpen: function(a) {
        ...
        var b = this.addOption(null, null, "ê²€ìƒ‰ì¤‘ìž…ë‹ˆë‹¤...");
        b.click = _DISABLE;
    ...
    OnFocus: function() {
        if(this.nodeSearch.val() === "ì„œë²„ê²€ìƒ‰") {
            this.nodeSearch.val("")
        }
        if(this.bind && this.bind.getValue().isEmpty()) {
            this.close();
