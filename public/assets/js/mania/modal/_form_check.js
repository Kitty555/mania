...
$.extend(_form_checker.prototype, {
    ...
    add: function(objItem) {
        /*
         *	ìž…ë ¥ í•­ëª©ì˜ êµ¬ì¡°
         *	custom	: ì‚¬ìš©ìž ì •ì˜ í•¨ìˆ˜ ì¶”ê°€(ë°˜ë“œì‹œ ê²°ê³¼ë¥¼ return(true,false)í•´ì•¼ í•¨)
         *  input	: í•´ë‹¹ ì»¨íŠ¸ë¡¤
         *	type	: íƒ€ìž…(number,price,string,date)
         *  range	: numberì¼ ê²½ìš° ë²”ìœ„ì„¤ì •({min:0, max:100}
         *	message	: ì¡°ê±´ì‹¤íŒ¨ì‹œ ë©”ì„¸ì§€
         */
...
$.extend(_form.protect, {
    ...
    hangul: function(input) {
        ...
        this.set(input,function(Event) {
            ...
            null,
            function(Event) {
                var objVal = ($(this).val().isEmpty()) ? "" : $(this).val().replace(/[^ê°€-íž£]/g,'');
                $(this).val(objVal);
            });
    },
